...
class DatabaseSeeder extends Seeder
{
    ...
    private $arrayPeliculas = array(
		...
		array(
			...
			'year' => '1974',
			'director' => 'Francis Ford Coppola',
			'poster' => 'https://vidaytiemposdeljuezroybean.files.wordpress.com/2014/07/525b2-the_godfather_part_2-al-pacino-poster.jpg',
			'rented' => false,
		...
		array(
			...
			'poster' => 'https://upload.wikimedia.org/wikipedia/en/7/7c/Vitaebella.jpg',
			'rented' => true,
		...
		array(
			...
			'poster' => 'https://i.ebayimg.com/images/g/YAYAAOSwybpbiXk-/s-l1600.jpg',
			'rented' => true,
		...
		array(
			...
			'year' => '1999',
			'director' => 'David Fincher',
			'poster' => 'https://pics.filmaffinity.com/fight_club-320750671-large.jpg',
			'rented' => true,
    ...
    private function seedUsers() {
        ...
        $u = new User;
        $u->name = "Ambrosio";
        $u->email = "apamo@hotmail.com";
        $u->password = bcrypt("ambrosio");
        $u->save();
    }
